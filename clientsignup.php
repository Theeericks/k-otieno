...
<body>
     ...
     <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            ?>
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse"style="backdround-color:green;">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 style="color:blue;">Welcome to K'Otieno Car Rental</h1>
            <br>
            <p style="color:blue;">Get started by creating your account</p>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: -1%; margin-bottom: 2%;">
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                <div class="panel-heading" style="color:blue;"> Create Account </div>
