        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="customerlogin.php" style=" font-size:15px;">Customer</a>
                    </li>
                    <li>
                        <a href="#" style=" font-size:15px;"> FAQ </a>
                    </li>
                </ul>
            </div>
                <?php   }
...
?>
    ...
    <h2 class="text-center"> Thank you for visiting K'Otieno Car Rental! We hope that you had a safe ride. </h2>

    <h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo "$id"; ?></span> </h3>


    <div class="container">
        <h5 class="text-center">Please read the following information about your bill.</h5>
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: orange;">You have succesfuly return your car.</h3>
                <br>
