...
?>
    ...
    <body>
           <!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color:cream;">
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-main-collapse">
                    <i class="fa fa-bars"></i>
                    </button>
                <a class="logo navbar-brand page-scroll" href="index.php" style="font-size:50px; letter-spacing:3px; color:black">
                   </a>
            </div>
            ...
            ?>
                    <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="#" style="color:red;"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo $_SESSION['login_customer']; ?></a>
                            </li>
                            <li>
                                <a href="#">History</a>
                            </li>
            ...
            ?>
                        ...
                        <div class="navigation" >
                            <ul class="ul">
                                <li>
                                    <a href="index.php" style="color:;">Home</a>
                                </li>
                                <li>
                                    <a href="clientlogin.php" style="color:red;">Client</a>
                                </li>
                              
                                <li>
                                    <a href="faq/index.php" style="color:;"> FAQ </a>
                                </li>
                            </ul>
                        </div>
                        <?php   }
        ...
        <div class="container" style="padding-top:20px;">
            <div class="jumbotron">
                <h1 style="color:black;">Welcome to K'Otieno Car Rental </span>
                </h1>
                <br>
                <p style="color:black;">Kindly LOGIN to continue or <a href="clientsignup.php" style="color:red; text-decoration:none;">create new account</a></p>
            </div>
        </div>
