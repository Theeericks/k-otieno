  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.php" style="font-size:35px; Color:black;">
                   </a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="customersignup.php" style="color:red;">Customer</a>
                    </li>
                    <li>
                        <a href="#"> FAQ </a>
                    </li>
...
if (!$success){
	die("The username you entered already been used! " );
}
