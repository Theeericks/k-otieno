    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                <butto type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-main-collapse">
                    <i class="fa fa-bars"></i>
                </butto>
                <a class="navbar-brand page-scroll" href="index.php" style="font-size:50px; lette-spacing:3px;">
                   </a>
            </div>
            ...
            ?>
                        ...
                        <div class="navigation">
                            <ul class="ul">
                                ...
                                <li>
                                    <a href="customerlogin.php" style="color:red;">Customer</a>
                                </li>
                                <li>
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 style="color:blue;">Welcome to K'Otieno Car Rental </span>
                </h1>
                <br>
                <p style="color:blue;">Kindly LOGIN to continue or <a href="customersignup.php" style="color:red; text-decoration;">create new account</a></p>
            </div>
        </div>

        <div class="container" style="margin-top: -2%; margin-bottom: 2%; font-size:15px;">
