...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for visiting K'Otieno Car Rental! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none;box-shadow:red; margin: 0 auto; text-align: center;">
                <h3 style="color: orange;">Your booking has been received and placed into out order processing system.</h3>
                <br>
                <h4>Please make a note of your <strong>order number</strong> now and keep in the event you need to communicate with us per your order.</h4>
                <br>
