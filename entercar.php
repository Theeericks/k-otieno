    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.php" style="font-size:35px;">
                   K'OTIENO CAR RENTAL </a>
            </div>
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"  style="color:red;"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <label>AC Fare per Km:</label>
            <input type="text" class="form-control" id="ac_price" name="ac_price" placeholder="AC Fare per km (in Kenya Shillings)" required>
          </div>

          <div class="form-group">
          <label>Non AC fare per Km:</label>
            <input type="text" class="form-control" id="non_ac_price" name="non_ac_price" placeholder="Non-AC Fare per km (in Kenya Shillings)" required>
          </div>

          <div class="form-group">
          <label>Ac price per dayss:</label>
            <input type="text" class="form-control" id="ac_price_per_day" name="ac_price_per_day" placeholder="AC Fare per day (in Kenya shillings)" required>
          </div>

          <div class="form-group">
          <label>Non-AC price per day:</label>
            <input type="text" class="form-control" id="non_ac_price_per_day" name="non_ac_price_per_day" placeholder="Non-AC Fare per day (in Kenya shillings)" required>
          </div>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>2022 K'Otieno Car Rental</h5>
                </div>
            </div>
        </div>
    </footer>
